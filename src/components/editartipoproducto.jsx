...
const EditarTipoProducto = () => {
  ...
  const eliminartp = async (idtp) => {
    try {
      ...
      const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/producto/editar_tipo_producto/${idtp}/`, {
        method: 'POST',
        body: formData,
      });
  ...
  const listarp= async ()=>{
    try {
      fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listarproductos/')
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/producto/editar_tipo_producto/${tipoProductoId}/`, {
        method: 'POST',
        body: formData,
      });
