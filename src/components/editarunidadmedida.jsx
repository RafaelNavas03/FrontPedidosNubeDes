...
const EditarUnidadesMedida = () => {
  ...
  const eliminartp = async (idca) => {
    try {
      ...
      console.log('C');
      const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/producto/editarum/${idca}/`, {
        method: 'POST',
        body: formData,
      });
      console.log('D');
  ...
  const handleEdit = async (values) => {
    try {
      ...
      const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/producto/editarum/${selectedUnidad.id_um}/`, {
        method: 'POST',
        body: formData,
      });
