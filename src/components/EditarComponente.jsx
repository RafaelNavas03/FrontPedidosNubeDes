...
const EditarComponenteForm = () => {
  ...
  const eliminarcomp = async (rec) => {
    try {
      ...
      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/eliminarcomponente/', {
        method: 'POST',
        body: formDataObject,
      });
      const data = await response.json();
  ...
  const handleModalOk = async (values) => {
    try {
      ...
      const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/producto/editarcomponente/${editComponente.id_componente}/`, {
        method: 'POST',
        body: formDataObject,
      });
      const data = await response.json();
