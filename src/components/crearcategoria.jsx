...
const CrearCategoria = () => {
  ...
  useEffect(() => {
    fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listatiposycategorias/')
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/crearcategoria/', {
        method: 'POST',
        body: formData,
      });
          ...
          rules={[
            { required: true, message: 'Ingrese el nombre de la categoría' },
            {
              validator: async (_, value) => {
                try {
                  const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/categoriaExist/', {
                    method: 'POST',
                    headers: {
