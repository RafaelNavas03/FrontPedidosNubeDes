...
const EditarReservacionesForm = () => {
  ...
  const cargarReservaciones = async () => {
    try {
      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Mesas/listar_reservaciones/');
      if (!response.ok) {
  ...
  const handleEditarReservacion = async () => {
    try {
      ...
      const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/Mesas/editar_reservacion/${idReservacion}/`, {
        method: 'POST',
        headers: {
