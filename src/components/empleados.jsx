...
const Empleados = ({ }) => {
    ...
    const listarEmpleados=() =>{
        fetch(`https://gestorpedidosbaknube-production.up.railway.app/empleado/listar-empleados/0/`)
        .then((response) => response.json())
        .then((data) => {
    ...
    const handleSucursalChange = (value) => {
        ...
        if (value !== 'Todas las sucursales') {
            fetch(`https://gestorpedidosbaknube-production.up.railway.app/empleado/listar-empleados/${encodeURIComponent(value)}/`)
                .then((response) => response.json())
                .then((data) => {
                    setEmpleados(data.empleados);
                })
