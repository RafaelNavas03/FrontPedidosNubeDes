...
const EditarEmpleado = ({ idsucur, oficio }) => {
    ...
    const fetchDataEmpleados = async () => {
        try {
            ...
            const responseEmpleados = await fetch('https://gestorpedidosbaknube-production.up.railway.app/empleado/listar-empleados/' + idsucur + '/');
        ...
        try {
            const responseSucursales = await fetch('https://gestorpedidosbaknube-production.up.railway.app/sucursal/sucusarleslist/');
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/empleado/editar-empleado/' + editedEmpleado.tipo + '/' + editedEmpleado.id + '/', {
                method: 'POST',
                headers: {
