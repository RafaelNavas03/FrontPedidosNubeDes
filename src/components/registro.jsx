...
const RegistroForm = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Login/crear/', {
        method: 'POST',
        headers: {
            ...
            <Form.Item
              ...
              rules={[
                ...
                },
                {
                  validator: async (_, value) => {
                    try {
                      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Login/DocumentExist/', {
                        method: 'POST',
                        headers: {
                          'Content-Type': 'application/json',
                        },
