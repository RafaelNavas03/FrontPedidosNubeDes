...
const Inventario = () => {
    ...
    const cargarInventario = async () => {
        try {
            const responseInventario = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Inventario/verinventario/');
            const dataInventario = await responseInventario.json();
            setInventario(dataInventario.inventario);

            const responseBodegas = await fetch('https://gestorpedidosbaknube-production.up.railway.app/bodega/listar/');
            const dataBodegas = await responseBodegas.json();
            setBodegas(dataBodegas.bodegas);

            const responseProductos = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listar/');
            const dataProductos = await responseProductos.json();
            setProductos(dataProductos.productos);

            const responseComponentes = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listarcomponentes/');
            const dataComponentes = await responseComponentes.json();
            setComponentes(dataComponentes.componentes);

            const responseUnidadesMedida = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listarum/');
    ...
    const onSaveEditStockMinimo = async (id) => {
        try {
            ...
            const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/Inventario/editar/${id}/`, {
                method: 'POST',
                body: formData,
            });
