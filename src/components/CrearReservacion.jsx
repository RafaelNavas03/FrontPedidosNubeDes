...
const CrearReservacionForm = () => {
  ...
  useEffect(() => {
    fetch('https://gestorpedidosbaknube-production.up.railway.app/cliente/ver_clientes/')
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Mesas/crear_reservacion/', {
        method: 'POST',
        body: formData,
      });
  ...
  useEffect(() => {
    const loadHorarios = async () => {
      if (selectedDate) {
        ...
        try {
          const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/horarios/get/${dayId}`);
          if (!response.ok) {
