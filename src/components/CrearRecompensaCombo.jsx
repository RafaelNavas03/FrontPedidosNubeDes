...
const CrearRecompensaComboForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const combosResponse = await fetch('https://gestorpedidosbaknube-production.up.railway.app/combos/ver_combos/');
        const recompensasCombosResponse = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Recompensas/listar_combos_con_recompensas/');
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Recompensas/crear_recompensa_combo/', {
        method: 'POST',
        body: formData,
      });
