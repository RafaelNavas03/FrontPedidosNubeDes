...
const CrearInventario = () => {
  ...
  useEffect(() => {
    const fetchSucursales = async () => {
      try {
        const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/sucursal/sucusarleslist/');
  ...
  useEffect(() => {
    const fetchBodegas = async () => {
      if (selectedSucursal) {
        try {
          const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/bodega/listar/?id_sucursal=${selectedSucursal}`);
          const data = await response.json();
  ...
  useEffect(() => {
    const fetchBodegas = async () => {
      try {
        const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/bodega/listar/');
        const data = await response.json();
        setBodegas(data.bodegas);
      } catch (error) {
        console.error('Error al obtener la lista de bodegas:', error);
    ...
    const fetchProductos = async () => {
      try {
        const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listar/');
        const data = await response.json();
    ...
    const fetchComponentes = async () => {
      try {
        const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listarcomponentes/');
        const data = await response.json();
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Inventario/crearinventario/', {
        method: 'POST',
        body: formData,
      });
