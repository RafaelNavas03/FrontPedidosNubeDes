...
const AdminSucursal = ({ idsucursalx }) => {
    ...
    const editGeosector = async (datosGeosectorjson) => {
        try {
            ...
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/sucursal/crearGeosector/', {
                method: 'POST',
                body: formDataObject,
            });
    ...
    const editHorarioCreate = async (jsonHorario) => {
        try {
            ...
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/horarios/edit/' + idhorario, {
                method: 'POST',
                body: formDataObject,
            });
    ...
    const handleHorarioCreate = async (jsonHorario) => {
        try {
            ...
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/horarios/CrearHorarioSucursal/', {
                method: 'POST',
                body: formDataObject,
            });
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/sucursal/cargarSucursal/${idsucursalx}`, {
                method: 'POST',
                headers: {
    ...
    const handleSwitchChange = (checked) => {
        ...
        fetch('https://gestorpedidosbaknube-production.up.railway.app/sucursal/actsucursal/', {
            method: 'POST',
            body: formData,
        })
    ...
    const handleGuardarClick = async () => {
        try {
            ...
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/sucursal/EditarSucursal/' + idsucursalx, {
                method: 'POST',
                body: formData,
            });
    ...
    const handleSaveUbicacion = async (latitud, longitud) => {
        Modal.confirm({
            ...
            onOk() {
                ...
                fetch('https://gestorpedidosbaknube-production.up.railway.app/sucursal/editarubicacion/', {
                    method: 'POST',
                    body: formData,
                })
                    .then(response => {
