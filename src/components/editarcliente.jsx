...
const EditarCliente = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/cliente/ver_clientes/');
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/cliente/actualizar_cliente/${editingCliente.id_cliente}/`, {
                method: 'POST',
                body: formData,
            });
