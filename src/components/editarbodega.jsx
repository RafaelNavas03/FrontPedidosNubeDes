...
const EditarBodegaForm = () => {
  ...
  const manejarEdicion = async () => {
    try {
      ...
      await fetch(`https://gestorpedidosbaknube-production.up.railway.app/bodega/editar/${idBodega}/`, {
        method: "POST",
  ...
  const cargarBodegas = async () => {
    try {
      const response = await fetch(
        `https://gestorpedidosbaknube-production.up.railway.app/bodega/listar/?page=${currentPage}`
      );
