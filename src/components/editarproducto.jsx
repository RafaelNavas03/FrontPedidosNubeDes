...
const EditarProducto = () => {
    ...
    const fetchSucursal = () => {
        setSucursalesData([]);
        const url = `https://gestorpedidosbaknube-production.up.railway.app/sucursal/sucusarleslist/`;
        fetch(url)
        ...
        try {
            if (selectedProducto.horarios.length > 0) {
                ...
                if (selectedHorario) {
                    ...
                    const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/horarios/edit/' + selectedHorario.id_horarios, {
                        method: 'POST',
                        body: formDataObject,
                    });
    ...
    const handleHorarioCreate = async (jsonHorario) => {
        try {
            ...
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/horarios/CrearHorarioProducto/', {
                method: 'POST',
                body: formDataObject,
            });
    ...
    const HorarioCreate = async (jsonHorario) => {
        try {
            ...
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/editarproducto/' + productId + '/', {
                method: 'POST',
                body: formDataObject,
            });
    ...
    const fetchproducto = async (page) => {
        try {
            const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/producto/listar/?page=${page}`);
    ...
    useEffect(() => {
        const fetchUmList = async () => {
            try {
                const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listarum/');
                const data = await response.json();
        ...
        const fetchCategoriaList = async () => {
            try {
                const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listar_categorias/');
                const data = await response.json();
    ...
    const fetchHorarioDetails = async (idHorario) => {
        try {
            ...
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/horarios/get/' + idHorario);
            const data = await response.json();
