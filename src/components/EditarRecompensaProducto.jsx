...
const EditarRecompensaProductoForm = () => {
    ...
    const fetchRecompensasProductos = async () => {
        try {
            const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Recompensas/lista_recompensas_producto/');
            if (!response.ok) {
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await fetch(`https://gestorpedidosbaknube-production.up.railway.app/Recompensas/editar_recompensa_producto/${editedRecompensaProducto.id_recompensa_producto}/`, {
                method: 'POST',
                body: formData,
            });
