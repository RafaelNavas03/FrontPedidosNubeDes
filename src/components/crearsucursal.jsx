...
const Crearsucursal = () => {
    ...
    const onFinish = async (values) => {
        try {
            ...
            const respuesta = await fetch('https://gestorpedidosbaknube-production.up.railway.app/sucursal/crear/', {
                method: 'POST',
                body: formData,
            });
                    ...
                    rules={[
                        ...
                        },
                        {
                            validator: async (_, value) => {
                                try {
                                    const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/sucursal/sucursalExist/', {
                                        method: 'POST',
                                        headers: {
