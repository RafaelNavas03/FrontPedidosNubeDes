...
const CrearRecompensaProductoForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const productosResponse = await fetch('https://gestorpedidosbaknube-production.up.railway.app/producto/listar/');
        const recompensasProductosResponse = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Recompensas/listar_productos_con_recompensas/');
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await fetch('https://gestorpedidosbaknube-production.up.railway.app/Recompensas/crear_recompensa_producto/', {
        method: 'POST',
        body: formData,
      });
